...
var shoot = game.newCircleObject({
	x : gameWidth + 17, y : 92,
	radius : joyRadius / 1.5,
	fillColor : pjs.colors.hex2rgba('#FFFFFF', 0.7)
})
...
var drawInterface = function () {
	...
	joy.setPositionS({
		x : joy.w / 4, 
		y : gameHeight - joy.h - 20
	})

	shoot.setPositionS({
		x : gameWidth - scope.w - 10, 
		y : gameHeight - scope.h - 40
	})
